        ...
        <div class="row">
            <div class="col-md-4">
                <div class="address">
                    ...
                    <div class="address-info">Paloc elementary alumni association,<br> Paloc Maragusan Compostela Valley</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="complaint">
                    <h2 class="tf"><i class="fa fa-mobile"></i></h2>
                    <div class="call-info">+639 9896 72162<br>
            ...
            <div class="col-md-4">
                <div class="feedback">
                    ...
                    <div class="email-info"> <a href="#">rex.corpuz@aol.com</a><br>
                    {{-- <span><a href="#">info@lionode.com</a></span> --}}
                </div>
            </div>
        </div>
    </div>
